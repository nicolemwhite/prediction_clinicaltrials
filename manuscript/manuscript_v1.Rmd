...
All records classified as observational study designs were included. All other study types were excluded [need to provide rationale here for excluding RCTS]. Dependent variables could be defined as a binary, continuous or time-to-event outcome. No restrictions were placed on model data sources or choice of independent variables, provided variables were collected at the individual level and two or more variables were included in the proposed prediction model. 

Eligible studies proposed a clinical prediction model as the primary study objectives, or as an objective within a multi-part study. Studies that planned to identify or validate independent risk factors associated with outcomes without mention of developing a subsequent prediction model were excluded. 
...
![Flowchart  note pretend numbers!](figures/flowchart.jpeg)
